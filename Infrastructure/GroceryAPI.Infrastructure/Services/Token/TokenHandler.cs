...
namespace GroceryAPI.Infrastructure.Services.Token
{
    public class TokenHandler : ITokenHandler
    {
        ...
        public Application.DTOs.Token CreateAccessToken(int second, AppUser user, string role)
        {
            ...
            JwtSecurityToken securityToken = new(
                ...
                claims: new List<Claim> { new(ClaimTypes.Name, user.UserName), new(ClaimTypes.Role, role) }
                );

            //Token oluşturucu sınıfından örnek alınıyor.
